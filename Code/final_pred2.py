...
class Application:
    ...
    def __init__(self):
        ...
        self.root.title("HandTalk: Real-Time Hand Sign Recognition")
        ...
        self.panel = tk.CTkLabel(self.root, width=640, height=480, text='') #Camera Output
        self.panel.place(x=80, y=115)

        self.panel2 = tk.CTkLabel(self.root,  width=480, height=480, text='')  # white bg img
        self.panel2.place(x=710,y=115)

        self.T = tk.CTkLabel(self.root)
        self.T.place(relx=0.25, y=15)
        self.T.configure(text="HandTalk: Real-Time Hand Sign Recognition", font=("Times New Roman", 55, "bold"))

        image1 = Image.open("hand-sign-language-alphabet.jpg")
        image1= image1.resize((640,480), Image.LANCZOS)
        test = ImageTk.PhotoImage(image1)
        label1 = tk.CTkLabel(self.root, image=test, text='')
        label1.image = test
        label1.place(x=1200,y=115)

        self.panel3 = tk.CTkLabel(self.root, text='')  # Current Symbol
        self.panel3.place(x=265, y=612)

        self.T1 = tk.CTkLabel(self.root)
        self.T1.place(x=80, y=610)
        self.T1.configure(text="Character :", font=("Times New Roman", 35, "bold"))

        self.panel5 = tk.CTkLabel(self.root, text='')  # Word
        self.panel5.place(x=260, y=662)

        self.T3 = tk.CTkLabel(self.root)
        self.T3.place(x=80, y=660)
        self.T3.configure(text="Word :", font=("Times New Roman", 35, "bold"))

        self.T4 = tk.CTkLabel(self.root)
        self.T4.place(x=80, y=760)
        self.T4.configure(text="Suggestions :", font=("Times New Roman", 35, "bold"))#red fg


        self.b1=tk.CTkButton(self.root, text='-')
        self.b1.place(relx=0.2,y=764)

        self.b2 = tk.CTkButton(self.root, text='-')
        self.b2.place(relx=0.3, y=764)

        self.b3 = tk.CTkButton(self.root, text='-')
        self.b3.place(relx=0.4, y=764)

        self.b4 = tk.CTkButton(self.root, text='-')
        self.b4.place(relx=0.5, y=764)

        self.speak = tk.CTkButton(self.root, text='-')
        self.speak.place(x=1400, y=660)
        self.speak.configure(text="Speak", font=("Times New Roman", 35), command=self.speak_fun)

        self.clear = tk.CTkButton(self.root)
        self.clear.place(x=1200, y=660)
        self.clear.configure(text="Clear", font=("Times New Roman", 35), command=self.clear_fun)
        ...
        try:
            ...
            if hands:
                ...
                if handz:
                    ...
                    self.panel3.configure(text=self.current_symbol, font=("Times New Roman", 35))

                    #self.panel4.configure(text=self.word, font=("Times New Roman", 30))



                    self.b1.configure(text=self.word1, font=("Times New Roman", 20), command=self.action1)
                    self.b2.configure(text=self.word2, font=("Times New Roman", 20),  command=self.action2)
                    self.b4.configure(text=self.word4, font=("Times New Roman", 20),  command=self.action4)
                    self.b3.configure(text=self.word3, font=("Times New Roman", 20),  command=self.action3)

            self.panel5.configure(text=self.str, font=("Times New Roman", 35))
        except Exception:
